...
val data as IData = DataUtil.fromJson('{Aspects: [{amount: 10, key: "aer"}]}');
print(data);
val data2 as IData = DataUtil.readSNBT("scripts/data/tcon_pickaxe.snbt");
print(data2.tag.StatsOriginal);